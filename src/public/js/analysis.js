            ...
            dataTable = new DataTable("#analysisTable", {
                ...
                initComplete: function () {
                    ...
                    if (dataTable) {
                        ...
                        const stats = {
                            total: data.length,
                            cambios: data.filter(row => row.tipo_patron === 'cambios').length,
                            regulares: data.filter(row => row.tipo_patron === 'regular').length,
                            temporales: data.filter(row => row.tipo_patron === 'temporal').length,
                            pendientes: data.filter(row => row.estado_gestion === 'Pendiente').length
                        };
