...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Definir initializeTable antes de usarla
          ...
          },
          {
            ...
            render: function(data) {
                ...
                switch (data) {
                    ...
                    case "Regularizar":
                        badgeClass = "bg-info";
                        tooltipText = "Este medicamento mantiene un patrón constante de descuadre";
                        break;
                    default:
        ...
        initComplete: function () {
          ...
          filterButtons.html(`
                        <div class="btn-group" role="group">
                            ...
                            <button type="button" class="btn btn-outline-primary filter-regular" 
          ...
          // Agregar el event listener para el nuevo filtro
          $(".filter-regular").on("click", function () {
            $.fn.dataTable.ext.search = [
              function (settings, searchData, index) {
                const row = dataTable.row(index).data();
                // Filtrar los que NO tienen cambios significativos
                return (
                  row &&
                  !row.tiene_cambios_tendencia &&
